...
module.exports = {
    ...
    '/api/lead-studio': { gate: 'lead_studio', beta: 'lead_studio', notes: 'Enterprise tier + beta opt-in — Studio Lead Studio tab (AI lead generation + enrichment via web search/KvK/Hunter/Apollo/Apify; collaborative checkable lead list). Gated purely on license × beta (no separate per-member permission); enabling the beta for the org is enough.' },
